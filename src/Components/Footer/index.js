    ...
    <div class='footer'>
      ...
      <div id="footer-bottom">
        <ul>
          <li>
            <h4>ENDEREÇO</h4>
            <p>R. José Luiz vieira, 442 - Jardim Atlâtico, Florianópolis - SC, 88095-380</p>
          </li>
          <li>
            <h4>CONTATO</h4>
            <p>infos@hotelardigo.com Tel: 048 1234-5678</p>
          </li>
          <li>
            <h4>ACEITAMOS</h4>
        ...
        <p id="copyright-text">© 2023 by Hotel Ardigo</p>
      </div>
    </div>
  );
